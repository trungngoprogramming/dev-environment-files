...
local function clearBlameVirtText() -- important for clearing out the text when our cursor moves
  api.nvim_buf_clear_namespace(0, 2, 0, -1)
end

api.nvim_create_autocmd("CursorHold", { callback = blameVirtText })
api.nvim_create_autocmd("CursorMoved", { callback = clearBlameVirtText })
api.nvim_create_autocmd("CursorMovedI", { callback = clearBlameVirtText })
